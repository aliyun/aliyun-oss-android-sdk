...
public class ConfigurationTest extends BaseTestCase {
    ...
    private static String IP_ENDPOINT = "59.110.190.19:8080";
    ...
    public void testDefault() throws Exception {
        ...
        assertEquals(mBucketName + "." + ENDPOINT, getCallback.serviceException.getHostId());
        assertTrue(getCallback.serviceException.getRawMessage().contains("<BucketName>"+ mBucketName + "</BucketName>"));
    }
    ...
    public void testSupportCnameEnable() throws Exception {
        ...
        get = new GetObjectRequest(mBucketName, "file1m");
    ...
    public void testCustomPathPrefixEnable() throws Exception {
        ...
        conf.setSupportCnameEnable(true);
        OSSClient oss = new OSSClient(InstrumentationRegistry.getTargetContext(), SCHEME + ENDPOINT + "/" + mBucketName, OSSTestConfig.credentialProvider, conf);
        GetObjectRequest get = new GetObjectRequest(mBucketName, "file1m");
        OSSAsyncTask task = oss.asyncGetObject(get, getCallback);
        task.waitUntilFinished();
        assertEquals(ENDPOINT, getCallback.serviceException.getHostId());
