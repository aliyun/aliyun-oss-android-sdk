...
public class OSSPutObjectTest extends BaseTestCase {
    ...
    public void testGetObjectVerifyStrict() {
        ...
        task.waitUntilFinished();
        assertTrue(putCallback.clientException.getMessage().startsWith("The object key is invalid."));
        ...
        assertTrue(getCallback.clientException.getMessage().startsWith("The object key is invalid."));
